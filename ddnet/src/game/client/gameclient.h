...
#include "components/c14_aimbot.h"
#include "components/c14_balance.h"
#include "components/c14_combat.h"
#include "components/c14_freeze.h"
#include "components/c14_movement.h"
...
public:
	...
	CC14Aimbot m_C14Aimbot;
	CC14Balance m_C14Balance;
	CC14Combat m_C14Combat;
	CC14FreezeHelper m_C14FreezeHelper;
	CC14Movement m_C14Movement;
	CEffects m_Effects;
...
private:
	...
	static void ConWar(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	bool IsWarPlayer(const char *pName) const;
	void SetLastChatMsg(int ClientId, const char *pMessage);
	const char *GetLastChatMsg(int ClientId, int64_t *pTime) const;
...
private:
	...
	char m_aaLastChatMsg[MAX_CLIENTS][256];
	int64_t m_aLastChatTime[MAX_CLIENTS];
