...
MACRO_CONFIG_STR(ClWarPlayers, cl_war_players, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Comma separated list of player names to mark as war targets (red nameplates)")
MACRO_CONFIG_INT(ClChatBalloons, cl_chat_balloons, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show chat messages as balloons above players")
MACRO_CONFIG_INT(ClChatBalloonsTime, cl_chat_balloons_time, 5, 1, 15, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Duration in seconds chat balloons are shown")
MACRO_CONFIG_INT(ClPlayerTracker, cl_player_tracker, 1, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show off-screen player indicators (0=off, 1=war list, 2=all)")
MACRO_CONFIG_INT(ClPlayerTrackerSize, cl_player_tracker_size, 40, 20, 80, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Size of player tracker indicators")
MACRO_CONFIG_INT(ClTransIn, cl_trans_in, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-translate incoming chat messages")
MACRO_CONFIG_INT(ClTransOut, cl_trans_out, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-translate outgoing chat messages before sending")
MACRO_CONFIG_INT(ClTransShowOriginal, cl_trans_show_original, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show original message alongside translation")
MACRO_CONFIG_STR(ClTransInSrc, cl_trans_in_src, 8, "ru", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Incoming translation source language (e.g. en, de, ru)")
MACRO_CONFIG_STR(ClTransInDst, cl_trans_in_dst, 8, "tr", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Incoming translation destination language (e.g. tr, en)")
MACRO_CONFIG_STR(ClTransOutSrc, cl_trans_out_src, 8, "tr", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Outgoing translation source language")
MACRO_CONFIG_STR(ClTransOutDst, cl_trans_out_dst, 8, "en", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Outgoing translation destination language")
MACRO_CONFIG_STR(ClTransApiEmail, cl_trans_api_email, 64, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Email sent to translation API (mymemory 'de=' param) for higher free daily quota")
MACRO_CONFIG_INT(ClTransRateLimitMs, cl_trans_rate_limit_ms, 300, 0, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Minimum milliseconds between translation requests to avoid API flooding (0 = disabled)")
MACRO_CONFIG_INT(ClTransCacheSize, cl_trans_cache_size, 200, 0, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Max cached translations to skip repeated API requests (0 = disabled)")
