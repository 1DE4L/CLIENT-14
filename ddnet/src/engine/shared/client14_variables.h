...
MACRO_CONFIG_INT(ClC14SettingsTab, cl_c14_settings_tab, 0, 0, 5, CFGFLAG_CLIENT | CFGFLAG_SAVE, "CLIENT 14 settings sub-tab (0=bots, 1=freeze, 2=translator, 3=misc, 4=hotkeys, 5=warlist)")
